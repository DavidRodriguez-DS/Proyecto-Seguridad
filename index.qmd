...
#Creamos un indice de inseguridad y de percepción:
...
enusc2023_reducida <- enusc2023_reducida %>% mutate(indice_percepcion = round(rowMeans(select(., P_AUMENTO_PAIS, P_AUMENTO_COM, P_AUMENTO_BARRIO), na.rm = TRUE), 3))

#Vemos que nuestras variables tienen NA al mínimo

sum(is.na(enusc2023_reducida$indice_percepcion))
sum(is.na(enusc2023_reducida$indice_inseguridad))
```
